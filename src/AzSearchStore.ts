...
export class AzSearchStore {
    ...
    public addCheckboxFacet(fieldName: string, dataType: Store.CheckboxDataType, count: number = 5) {
    ...
    public setFacetRange(fieldName: string, lowerBound: number | Date, upperBound: number | Date) {
